...
export class CarcardComponent implements OnInit {
 ...
 searchkey!: string;
  ...
  constructor(private api: CardService, private insuranceservice:InsuranceService, private spinner: NgxSpinnerService
,    private router:Router, private cartapi: AddtocartService,private insuranceservices:InsuranceService) {
